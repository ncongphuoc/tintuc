...
class General {
    ...
    const SITE_DOMAIN_FULL = 'http://tuoitre.mobi';
    const SITE_DOMAIN_STATIC = (APPLICATION_ENV == 'production') ? '' : 'http://dev.st.tintuc.com';
    const TITLE_META = " - Tuoitre.mobi";
    const SITE_AUTH = "Tuoitre.mobi";
    const SITE_DOMAIN = 'Tuoitre.mobi';
    const SITE_SLOGAN = 'Tin tức tổng hợp';
    const SITE_HOTLINE = '';
    const SITE_NAME = 'Tuoitre.mobi';
    const SITE_CRAWLER = 'https://quantrimang.com';
    const NAME_CRAWLER = 'Quản Trị Mạng';
    ...
    const DESCRIPTION_DEFAULT = 'Tuoitre.mobi- Trang tin tức giải trí - xã hội Việt Nam - Quốc Tế. Đưa tin nhanh nhất : thời trang, video ngôi sao, phim ảnh, tình yêu, học đường, các chuyển động xã hội.';
